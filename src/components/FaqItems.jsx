...
const FaqItems = ({ item, index }) => {
  ...
  return (
    <div className="relative z-2 mb-16">
      <div
        className="group relative flex items-center cursor-pointer justify-between gap-10 px-7"
      ...
      >
        ...
        <div
          className={clsx(
            "faq-icon items-center justify-center relative flex size-12 rounded-full border-2 border-s2 shadow-400 transition-all duration-500 group-hover:border-s4",
